...
@section('content')
    ...
    <div class="container shadow p-4" style="background-color: #f9f9f9; border-radius: 10px;">
        <div class="d-flex justify-content-between align-items-center mx-2">
            ...
            <a href="{{ route('jadwals.create') }}" class="btn btn-success">
                <i class="bi bi-calendar-event-fill"></i> &nbsp;Tambah Jadwal</a>
        </div>
        @if (session('success'))
                        ...
                        @if ($jadwals && $jadwals->count() > 0)
                            @foreach ($jadwals as $jadwal)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('jadwals.edit', $jadwal->id) }}" class="btn btn-primary btn-sm">
